...
import waterFragmentsahder from './shaders/Water/fragment.glsl'

// console.log(waterVertexsahder)
...
const waterMaterial = new THREE.ShaderMaterial({
    ...
    fragmentShader: waterFragmentsahder,
    uniforms:
    {
        uTime: {value: 0},
...
gui.add(waterMaterial.uniforms.uSmallWavesIteration, 'value').min(0).max(5).step(0.001).name('uSmallWavesIteration')

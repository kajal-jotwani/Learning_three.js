...
gltfLoader.setDRACOLoader(dracoLoader) // provide draco loader instance to gltf loader instance
...
//   (gltf) => {
//     // solution 1: to load all the children of the array
//     // while(gltf.scene.children.length){
//     //     scene.add(gltf.scene.children[0])
//     // }

//     // solution 2: to duplicate the children array to have unaltered independant array
